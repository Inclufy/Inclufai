...
from .admin_request_views import (
    DemoRequestListView,
    QuoteRequestListView,
    InvoiceRequestListView,
    get_demo_request,
    update_demo_request,
...
urlpatterns = [
    ...
    path("create-checkout/", views.create_checkout_session, name="create-checkout-alias"),
    ...
    # Request endpoints (public - invoice, quote, demo)
    path("request-invoice/", views.request_invoice, name="request-invoice"),
    ...
    path("admin/demos/", DemoRequestListView.as_view(), name="admin-demos"),
    path("admin/demos/<int:pk>/", get_demo_request, name="admin-demo-detail"),
    path("admin/demos/<int:pk>/update/", update_demo_request, name="admin-demo-update"),
    
    path("admin/quotes/", QuoteRequestListView.as_view(), name="admin-quotes"),
    path("admin/quotes/<int:pk>/update/", update_quote_request, name="admin-quote-update"),
    
    path("admin/invoices/", InvoiceRequestListView.as_view(), name="admin-invoices"),
    path("admin/invoices/<int:pk>/update/", update_invoice_request, name="admin-invoice-update"),
    
    path("admin/stats/", get_request_stats, name="admin-stats"),
