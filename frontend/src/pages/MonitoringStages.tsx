...
const MonitoringStages = () => {
  ...
  return (
    <div className="min-h-full bg-background">
      <ProjectHeader />
      <div className="p-6">
        <h1 className="text-2xl font-bold text-foreground mb-6">{pt("Documents")}</h1>

        <Card className="p-6">
          <h2 className="text-lg font-semibold text-foreground mb-6">{pt("Stages")}</h2>
            ...
            {stages.map((stage) => (
              <Card key={stage.id} className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  {stage.linkedDocs} {pt("linked documents")}
                </p>
